<template>
  <div class="container-fluid mt-4">
    <div class="card">
      ...
      <div class="card-body">
        <form @submit.prevent="productUpdateAction" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <img style="width: 200px; height: 128px" :src="productContent.image_url" alt="">
          </div>
...
export default {
  ...
  methods: {
    ...mapActions('productModule', ['showProduct', 'productUpdate']),
    productUpdateAction () {
      ...
      this.productUpdate(data)
        .then(res => {
          ...
          Notify.toaster('Product Successfully Updated', 'success')
        })
        .catch(error => {
    ...
    fileLoad (event) {
      ...
      if (real_file.size > 1040770) {
        ...
        reader.onload = event => {
          this.productContent.image_url = event.target.result
        }
